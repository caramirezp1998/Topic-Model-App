...
If you are interest in the code I created to web scrape just check the news retriever file.  If you are interested in using the news files they are available in the "El_Tiempo" directory. 
